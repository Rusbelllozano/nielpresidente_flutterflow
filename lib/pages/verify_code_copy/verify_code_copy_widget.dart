...
import 'verify_code_copy_model.dart';
export 'verify_code_copy_model.dart';

class VerifyCodeCopyWidget extends StatefulWidget {
  const VerifyCodeCopyWidget({
    super.key,
  ...
  @override
  State<VerifyCodeCopyWidget> createState() => _VerifyCodeCopyWidgetState();
}

class _VerifyCodeCopyWidgetState extends State<VerifyCodeCopyWidget> {
  late VerifyCodeCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyCodeCopyModel());
